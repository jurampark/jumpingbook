...
from recommend.views import BookListView, RatingBookView, RatedBookListView, CancelRatingBookView, SearchedBookListView
...
urlpatterns = patterns('',
   ...
   url(r'^book/search/$', SearchedBookListView.as_view(), name='searched_book'),
)
